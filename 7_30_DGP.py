...
params.add_argument('-num_points', type=int, default=0, help=' epoch number of optimal parameters ')
...
test_x = train_x
test_y = train_y
print('train_y in dB',train_y.view(1,train_x.size(0)))
...
# in dB
predictions = 20 * torch.log10(predictions)
